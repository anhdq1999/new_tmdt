...
const bg3 = require('./../../images/background/bg6.jpg');


function Footer(props) {
    return (<footer className="site-footer style1">
                    ...
                    <div className="row">
                        <div className="col-lg-3 col-md-6 col-sm-5 footer-col-4">
                            ...
                            <ul className="list-inline">
                                <li><Link to={''} className="site-button facebook sharp"><i
                                    className="fa fa-facebook"></i></Link></li>
                                <li><Link to={''} className="site-button google-plus sharp"><i
                                    className="fa fa-google-plus"></i></Link></li>
                                <li><Link to={''} className="site-button linkedin sharp"><i
                                    className="fa fa-linkedin"></i></Link></li>
                                <li><Link to={''} className="site-button twitter sharp"><i
                                ...
                                <SimpleReactLightbox>
                                    <SRLWrapper>
                                        <ul className="clearfix mfp-gallery">
                                            <li className="img-effect2"><Link to={''} className="mfp-link"
                                                                              title="Title Come Here"><img
                                                src={require('./../../images/gallery/img1.jpg')} alt=""/></Link>
                                            </li>
                                            <li className="img-effect2"><Link to={''} className="mfp-link"
                                                                              title="Title Come Here"><img
                                                src={require('./../../images/gallery/img2.jpg')} alt=""/></Link>
                                            </li>
                                            <li className="img-effect2"><Link to={''} className="mfp-link"
                                                                              title="Title Come Here"><img
                                                src={require('./../../images/gallery/img3.jpg')} alt=""/></Link>
                                            </li>
                                            <li className="img-effect2"><Link to={''} className="mfp-link"
                                                                              title="Title Come Here"><img
                                                src={require('./../../images/gallery/img4.jpg')} alt=""/></Link>
                                            </li>
                                            <li className="img-effect2"><Link to={''} className="mfp-link"
                                                                              title="Title Come Here"><img
                                                src={require('./../../images/gallery/img5.jpg')} alt=""/></Link>
                                            </li>
                                            <li className="img-effect2"><Link to={''} className="mfp-link"
                                                                              title="Title Come Here"><img
                                                src={require('./../../images/gallery/img6.jpg')} alt=""/></Link>
                                            </li>
                                            <li className="img-effect2"><Link to={''} className="mfp-link"
                                                                              title="Title Come Here"><img
                                                src={require('./../../images/gallery/img7.jpg')} alt=""/></Link>
                                            </li>
                                            <li className="img-effect2"><Link to={''} className="mfp-link"
                                                                              title="Title Come Here"><img
                                                src={require('./../../images/gallery/img8.jpg')} alt=""/></Link>
                                            </li>
                                            <li className="img-effect2"><Link to={''} className="mfp-link"
                                                                              title="Title Come Here"><img
                                                src={require('./../../images/gallery/img9.jpg')} alt=""/></Link>
                                            </li>
                                        </ul>
                                    </SRLWrapper>
                                </SimpleReactLightbox>
            ...
            <div className="footer-bottom">
                <div className="container">
                    <div className="row">
                        ...
                        <div className="col-lg-6 col-md-6 text-right "><span> Design With <i
                            className="fa fa-heart text-primary heart"></i> By Dexignlabs </span></div>
                    </div>
                </div>
            </div>
        </footer>)
