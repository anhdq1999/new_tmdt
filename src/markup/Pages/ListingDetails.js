                    ...
                    <div className="listing-info-box">
                        ...
                        <div className="listing-info">
                            ...
                            <div className="listing-info-right text-center">
                                <Link to={''} className="site-button gray mr-3"><i
                                    className="la la-heart-o m-r5"></i> Favorite </Link>
                                <div className="dropdown dropdown-btn">
                                    <button className="site-button dropdown-toggle" type="button"
                    ...
                    <ul className="listing-nav nav justify-content-center">
                        ...
                        <li>
                            <Link className={classnames({active: activeTab === '2'})}
                                  onClick={() => {
                                      toggle('2');
                                  }}><i className="la la-file-text"></i><span>Description</span>
                            </Link>
                        </li>
                        <li>
                            <Link className={classnames({active: activeTab === '3'})}
                                  onClick={() => {
                                      toggle('3');
                                  }}><i className="la la-list-alt"></i><span>Listing Features</span>
                            </Link>
                        </li>
                        <li>
                            <Link className={classnames({active: activeTab === '4'})}
                                  onClick={() => {
                                      toggle('4');
                                  }}><i className="la la-image"></i><span>Photos</span>
                            </Link>
                        </li>
                        <li>
                            <Link className={classnames({active: activeTab === '5'})}
                                  onClick={() => {
                                      toggle('5');
                                  }}><i className="la la-video-camera"></i><span>Videos</span>
                            </Link>
                        </li>
                        <li>
                            <Link className={classnames({active: activeTab === '6'})}
                                  onClick={() => {
                                      toggle('6');
                                  }}><i className="la la-calendar-check-o"></i><span>Events</span>
                            </Link>
                        </li>
                        <li>
                            <Link className={classnames({active: activeTab === '7'})}
                                  onClick={() => {
                                      toggle('7');
                                  }}><i className="la la-star-o"></i><span>Reviews</span>
                            </Link>
                        </li>
                    </ul>
                </div>
                            ...
                            <div className="row">
                                <div className="col-xl-8 col-lg-7 col-md-12">
                                    <div className="content-box">
                                        <div className="content-header">
                                            <h3 className="title"><i className="la la-star-o m-r5"></i> average reviews
                                            </h3>
                                        </div>
                                        ...
                                        <div className="content-footer content-btn">
                                            <Link data-toggle="modal" data-target="#favorite" to={''}
                                                  className="site-button"><i className="la la-star-o m-r5"></i> ADD A
                                                REVIEW</Link>
                                        </div>
                                    </div>
                                    <div className="content-box">
                                        <div className="content-header">
                                            <h3 className="title"><i className="la la-file-text m-r5"></i> description
                                            </h3>
                                        </div>
                                        <div className="content-body">
                                    ...
                                    <div className="content-box">
                                        <div className="content-header">
                                            <h3 className="title"><i className="la la-list-alt m-r5"></i>listing
                                                features</h3>
                                        </div>
                                        <div className="content-body">
                                                ...
                                                <ul>
                                                    <li>
                                                            <span className="check-km" title="Light Gallery Grid 1">
                                                                <Link to={''}>
                                                                    <div className="dlab-post-thum"><img
                                    ...
                                    <div className="content-box">
                                        <div className="content-header">
                                            <h3 className="title"><i className="la la-calendar-check-o m-r5"></i>events
                                            </h3>
                                        </div>
                                        <div className="content-body">
                                            <div className="row">
                                                <div className="col-lg-6 col-md-6 col-sm-6">
                                                    <div className="listing-bx event-listing m-b10">
                                                        <div className="listing-media">
                                                            <Link to={''}>
                                                                <img src={require('./../../images/featured/pic3.jpg')}
                                                                     alt=""/>
                                                            </Link>
                                                        </div>
                                                        <div className="listing-info">
                                                            ...
                                                            <ul className="event-meta">
                                                                <li className="event-date"><span>SEP</span>
                                                                    <strong>04</strong></li>
                                                                <li>Tuesday 08:00</li>
                                                ...
                                                <div className="col-lg-6 col-md-6 col-sm-6">
                                                    <div className="listing-bx event-listing m-b10">
                                                        <div className="listing-media">
                                                            <Link to={''}>
                                                                <img src={require('./../../images/featured/pic2.jpg')}
                                                                     alt=""/>
                                                            </Link>
                                                        </div>
                                                        <div className="listing-info">
                                    ...
                                    <div className="content-box">
                                        <div className="add-reviews">
                                            <h5 className="title m-b0"><span className="text-primary">24 </span>Reviews
                                                For Triper</h5>
                                            <Link data-toggle="modal" data-target="#favorite" to={''}
                                                  className="site-button"><i className="la la-star-o m-r5"></i> Add a
                                                review</Link>
                                    ...
                                    <div className="comments-review-area">
                                        <div className="comments-review-box">
                                            ...
                                            <div className="review-body">
                                                ...
                                                <p className="review-content">There are many variations of passages of
                                                                ...
                                                                <div className="comment-info">
                                                                    <div className="info-group">
                                                                        <h3 className="title"><Link to={''}>Diamond
                                                                            Anderson</Link></h3>
                                                                        <span
                                                                            className="comment-date">July 25, 2019</span>
                                                                    </div>
                                                                    <p className="comment-text">There are many
                                ...
                                <div className="col-xl-4 col-lg-5 col-md-12 sticky-top">
                                    <aside className="side-bar listing-side-bar">
                                        <div className="content-box">
                                            <div className="content-header">
                                                <h3 className="title"><i className="la la-bullhorn m-r5"></i>Best Seller
                                                </h3>
                                            </div>
                                            <div className="content-body">
                                                <div className="tour-booking-form">
                                                    ...
                                                    <form className="row sp15">
                                                        ...
                                                        <div className="form-group col-md-12">
                                                            <button
                                                                className="site-button btn-block text-uppercase button-md">Submit
                                                                Enquiry
                                                            </button>
                                                        </div>
                                                    </form>
                                        ...
                                        <div className="content-box">
                                            <div className="content-header">
                                                <h3 className="title"><i className="la la-bullhorn m-r5"></i>listing
                                                ...
                                                <div className="widget recent-posts-entry posts-style1 posts-column-2">
                                                        ...
                                                        <div className="widget-post clearfix">
                                                            ...
                                                            <div className="dlab-post-info">
                                                                <div className="dlab-post-header">
                                                                    <h6 className="post-title"><Link to={''}>Moments To
                                                                        Remember From Directory</Link></h6>
                                                                    <div className="dlab-post-meta">
                                                                        <ul>
                                                                            <li className="post-rating">
                                                                                <span
                                                                                    className="average-rating">7.0 </span>
                                                    ...
                                                    <div className="widget-post-bx">
                                                        <div className="widget-post clearfix">
                                                            ...
                                                            <div className="dlab-post-info">
                                                                <div className="dlab-post-header">
                                                                    <h6 className="post-title"><Link to={''}>A Thing Of
                                                                        The Past</Link></h6>
                                                                    <div className="dlab-post-meta">
                                                                        <ul>
                                                                            <li className="post-rating">
                                                    ...
                                                    <div className="widget-post-bx">
                                                        <div className="widget-post clearfix">
                                                            ...
                                                            <div className="dlab-post-info">
                                                                <div className="dlab-post-header">
                                                                    <h6 className="post-title"><Link to={''}>Ten Things
                                                                        Your Competitors</Link></h6>
                                                                    <div className="dlab-post-meta">
                                                                        <ul>
                                                                            <li className="post-rating">
                                                                                <span
                                                    ...
                                                    <div className="widget-post-bx">
                                                        <div className="widget-post clearfix">
                                                            ...
                                                            <div className="dlab-post-info">
                                                                <div className="dlab-post-header">
                                                                    <h6 className="post-title"><Link to={''}>Remember
                                                                        From Directory</Link></h6>
                                                                    <div className="dlab-post-meta">
                                                                        <ul>
                                                                            <li className="post-rating">
                                                                                <span
                                        ...
                                        <div className="content-box">
                                            <div className="content-header">
                                                <h3 className="title"><i className="la la-map-signs m-r5"></i>business
                                                    info</h3>
                                            </div>
                                            <div className="content-body">
                                                ...
                                                <ul className="list-inline m-tb20">
                                                    <li><Link to={''} className="site-button sharp"><i
                                                ...
                                                <Link to={''} className="site-button  btn-block gray"><i
                                                    className="fa fa-envelope"></i> Inbox</Link>
                                            </div>
                                        </div>
                                        <div className="content-box">
                                            <div className="content-header">
                                                <h3 className="title"><i className="la la-sitemap m-r5"></i>categories
                                                </h3>
                                            </div>
                                            <div className="content-body">
                                        ...
                                        <div className="content-box">
                                            <div className="content-header">
                                                <h3 className="title"><i className="la la-bar-chart m-r5"></i>statistic
                                                </h3>
                                            </div>
                                            <div className="content-body">
                                                <ul className="icon-box-list list-col-2">
                                        ...
                                        <div className="content-box">
                                            ...
                                            <div className="content-body">
                                                ...
                                                <p>Claim listing is the best way to manage and protect your
                                                    business.</p>
