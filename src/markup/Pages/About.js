                    ...
                    <div className="container">
                        <div className="row align-items-start m-b20">
                            <div className="col-md-12 col-lg-6">
                                <h2>Hello. Our agency has been present for over 20 years. We make the best for all our
                                    customers.</h2>
                            </div>
                        ...
                        <div className="row">
                            <div className="col-lg-6 col-md-6 col-sm-6 m-b30 col-12"><img
                                src={require('./../../images/blog/default/thum2.jpg')} alt=""/></div>
                            <div className="col-lg-6 col-md-6 col-sm-6 m-b30 col-12"><img
                                src={require('./../../images/blog/default/thum3.jpg')} alt=""/></div>
                        </div>
                        <div className="row">
                        ...
                        <div className="row">
                            <div className="col-lg-12 text-center col-md-12">
                                <div className="add-area">
                                    ...
                                    <p>If you’re looking for a truly memorable family break here you find the lowest
                                        price on the right hotel for you. It's indescribable. Stay up to date and check
                                        out the deals for these trending destinations.</p>
                                    ...
                                    <div className="blog-post blog-grid blog-style-1">
                                        ...
                                        <div className="dlab-info">
                                            ...
                                            <div className="dlab-post-title ">
                                                <h5 className="post-title font-20"><Link
                                                    to={'./blogdetails'}>{item.title}</Link></h5>
                                            </div>
                                            <div className="dlab-post-readmore blog-share">
                                                <Link to={'./blogdetails'} title="READ MORE" rel="bookmark"
