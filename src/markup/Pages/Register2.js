                            ...
                            <div class="login-form">
                                ...
                                <div id="register" class="tab-pane">
                                    <form class="dlab-form">
                                        <div class="form-head">
                                            <h3 class="form-title m-t0">Create an account! It's free and<span
                                                class="text-primary">  always will be.</span></h3>
                                        ...
                                        <div class="form-group-bx">
                                            <div class="form-group input-form">
                                                ...
                                                <input name="dzName" required="" class="form-control"
                                                       placeholder="Dummy Name" type="text"/>
                                            </div>
                                            <div class="form-group input-form">
                                                <label>Email Id</label>
                                                <input name="dzName" required="" class="form-control"
                                                       placeholder="info123@example.com" type="text"/>
                                            </div>
                                            <div class="form-group input-form">
                                                <label>Password</label>
                                                <input name="dzName" required="" class="form-control"
                                                       placeholder="Password" value="123456789" type="password"/>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <input type="checkbox" id="privacy-policy"/>
                                            <label for="privacy-policy">I agree to the <Link to={''} class="btn-link">Terms
                                                of Service </Link>& <Link to={''} class="btn-link">Privacy
                                                Policy </Link></label>
                                        </div>
                                        <div class="form-group">
